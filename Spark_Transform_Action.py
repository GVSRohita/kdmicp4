...
# RDD Transformations
# Grouping data and counting their total based on the 'Payment Method' feature
payment = df.groupBy('PaymentMethod').count()
print("Grouping data based on Payment Method:")
print(payment.show())
# Ordering data based on the 'Paperless Billing' feature
billing = df.orderBy('PaperlessBilling')
print("Ordering data based on Paperless Billing:")
print(billing.show())
...
print("Transformation 1: Grouping data based on the Payment Method feature")
print(transform_1.show())
# Ordering data based on the 'Paperless Billing' feature
transform_2 = df.orderBy('PaperlessBilling').take(5)
print("Transformation 2: Ordering data based on the Paperless Billing type used")
print(transform_2)
# Identifying any distinct features/elements present within the data
